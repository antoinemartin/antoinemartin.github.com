...
You can choose among [several message brokers](http://docs.celeryproject.org/en/latest/getting-started/brokers/index.html).
...
``command`` specifies the ``manage.py`` command to run and ``parameters``
